...
<div class="col-md-12">
	<div class="row">
		<?php echo form_open('asisten_catatan/simpan') ?>
            <div class="col-md-6">
                <input type="text" name="namacat" placeholder="Nama Catatan" class="form-control w8">
            </div>
            <div class="col-md-12 jarak-atas">
                <textarea rows="10" id="area4" class="form-control" placeholder="Isi Catatan" name="catatan"></textarea>
            </div>
