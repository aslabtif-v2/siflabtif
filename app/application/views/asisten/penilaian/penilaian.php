...
<script>
	$(document).ready(function(e) {
		...
		$('.tr-nilai',this).click(function(){
			...
			$.ajax({
				type:"POST",
				url:"<?php echo base_url() ?>index.php/asisten_penilaian/nilai",
...
<div class="col-md-12">
    ...
    <table class="table-nilai">
    	<tr>
        	...
        	<th class="td-nilai"><?php echo anchor('asisten_penilaian/edit_persentase/'.$id_praktikum,'<i class="glyphicon glyphicon-edit"></i> Edit','title="Edit persentase nilai"') ?></th>
        </tr>
    </table>
