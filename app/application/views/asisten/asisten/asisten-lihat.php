<link href="<?php echo base_url() ?>assets/css/plugins/social-buttons/bootstrap-social.css" rel="stylesheet">
<style>
...
<div class="col-md-12">
	<h2 class="page-header">Biodata Asisten</h2>
</div>
<div class="col-md-12">
	<div class="panel panel-default" style="border-radius:0px 0px 0px 0px;">
        <div class="panel-body">
            ...
            <div class="col-md-5" style="margin-left:40px; ">
                ...
                <?php echo form_open_multipart('asisten_biodata/update_foto_asisten') ?>
                    ...
                    <button type="submit" class="btn btn-dropbox" style="margin-top:30px;">
        ...
        <?php 
			echo anchor('asisten_biodata/edit_asisten/'.$rz->id_asisten,'<i class="glyphicon space glyphicon-edit"></i> Edit','title="Edit" class="btn btn-warning kembali"');
			}
		?>
    </div>
</div>