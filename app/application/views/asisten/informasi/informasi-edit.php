...
<div class="col-lg-12 table-responsive">
    <div class="panel panel-default" style="width:100%;margin:auto;">
    	<div class="panel-body">
        	<?php 
				echo form_open('asisten_informasi/update_informasi') ;
				foreach($informasi as $info){
				echo form_hidden('id_info',$info->id_informasi);		
			?>
                    <textarea rows="10" id="area4" class="form-control" name="informasi"><?php echo $info->informasi ?></textarea>
                    <button type="submit" class="btn btn-warning simpan">Ganti</button>
            <?php 
				} 
				echo anchor('asisten_informasi','Batal','class="btn btn-default kembali"') 
			?>
            </form>
    	</div>
    </div>
