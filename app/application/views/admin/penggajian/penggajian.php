<script>
	$(document).ready(function(e) {
        $('.dari').change(function(){
			...
			var bulan = $('.bulan').val();
			window.location.href='<?php echo base_url() ?>index.php/admin_penggajian/gaji/'+dari+'/'+sampai+'/'+bulan;
		});
...
<div class="col-lg-12">
	...
	<?php echo anchor('admin_penggajian/cetak/'.$dari.'/'.$sampai.'/'.$bulan,'<i class="glyphicon glyphicon-print"></i> Cetak','class="btn ctk btn-primary"') ?>
</div>