<script>
	$(document).ready(function(e) {
		$('.hari').change(function(){
			var hari = $('.hari').val();
			if(hari!=''){
				window.location.href='<?php echo base_url() ?>index.php/admin_jadwal/pilih_hari/'+hari;				
			}
			else{
				window.location.href='<?php echo base_url() ?>index.php/admin_jadwal/hari_ini';
			}
		});
	});
</script>
...
<div class="col-md-12">
    <div class="panel panel-default">
    	<div class="panel-heading">
        	<i class="fa fa-clock-o fa-fw"></i> Jadwal Praktikum Hari <?php echo $hari ?>
        </div>
