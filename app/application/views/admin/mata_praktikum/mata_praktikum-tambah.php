<div class="col-lg-12">
	<h1 class="page-header">Tambah Mata Praktikum</h1>
</div>
<div class="col-lg-12">
	<div class="panel panel-default" style="width:400px; margin:auto;">
        <div class="panel-body ">
			<?php echo form_open('admin_mata_praktikum/post_matkum') ?>
                <table>
                    <tr>
                        <td><b>Mata Praktikum</b></td>
                        <td width="30"></td>
                        <td width="230"><input required type="text" placeholder="Mata Praktikum" name="matkum" class="form-control"></td>
                    </tr>
                </table>
