...
<div class="col-lg-12">
	<h1 class="page-header">Edit Asisten</h1>
</div>
<div class="col-lg-12">
        ...
        <div class="panel-body">
			<div class="col-lg-6">
				<?php 
					...
					echo form_open_multipart('admin_asisten/update_asisten','class="form-horizontal"');
				...
				?>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="<?php echo $mhr->username ?>" required name="username" placeholder="Username">
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                      	<select name="jabatan" required class="form-control">
                            ...
                            <?php foreach($jabatan as $rz) { 
								if($rz->id_jabatan==$mhr->id_jabatan){
									$pilih = 'selected';	
								}
								else{
									$pilih ='';
								}
								echo "<option value='$rz->id_jabatan' $pilih>$rz->jabatan</option>";
							?>
                            <?php } ?>
                        </select>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" maxlength="4" value="<?php echo $tgl[0] ?>" class="form-control input-tahun" name="tahun" placeholder="Tahun">
                        ...
                        <input type="text" maxlength="2" value="<?php echo $tgl[2] ?>" class="form-control input-tanggal" name="tanggal" placeholder="Tgl">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Alamat</label>
                      <div class="col-sm-10">
                        <textarea name="alamat" class="form-control"><?php echo $mhr->alamat ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Email</label>
                      <div class="col-sm-10">
                        <input type="email" class="form-control" value="<?php echo $mhr->email ?>" name="email" placeholder="Email">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Tahun_Masuk</label>
                      <div class="col-sm-10">
                        <input type="number" class="form-control" value="<?php echo $mhr->masuk ?>" required name="tmasuk" placeholder="Tahun Masuk">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Tahun_Keluar</label>
                      <div class="col-sm-10">
                        <input type="number" class="form-control" value="<?php echo $mhr->keluar ?>" name="tkeluar" placeholder="Tahun Keluar">
                      </div>
                    </div>
			</div>
            <div class="col-lg-5" style="margin-left:40px; ">
                ...
                <input type="hidden" value="<?php echo $mhr->foto ?>" name="foto_lama">
                    ...
                    <?php } echo anchor('admin_asisten','Batal','class="btn btn-default kembali"') ?>
                </form>
    </div>
</div>